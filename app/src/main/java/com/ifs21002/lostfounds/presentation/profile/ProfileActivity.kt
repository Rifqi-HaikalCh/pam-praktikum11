...
import com.ifs21002.lostfounds.databinding.ActivityProfileBinding
import com.ifs21002.lostfounds.helper.getImageUri
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun loadProfileData(profile: Any?) {
        if (profile is DataUserResponse) {
            binding.apply {
